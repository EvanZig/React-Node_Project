  ...
  const headers = {
    ...
    return (
        ...
        <Form.Group className="mb-3" controlId="Firstname">
            ...
            <Form.Control type="text" placeholder="Enter Name" name="firstname" value={userData.firstname} onChange={handleChange} />
        </Form.Group>

        <Form.Group className="mb-3" controlId="Lastname">
            <Form.Label className="text-center">Lastname</Form.Label>
            <Form.Control type="text" placeholder="Enter Name" name="lastname" value={userData.lastname} onChange={handleChange} />
        </Form.Group>

        <InputGroup className="mb-3">
            <InputGroup.Text>Age</InputGroup.Text>
            <Form.Control type="text" name="age" value={userData.age} onChange={handleChange} />
        </InputGroup>

        <Form.Group className="mb-3">
            <Form.Label className="text-center"> Date of birth </Form.Label>
            <Form.Control type="date" name='dateOfBirth' value={userData.dateOfBirth} onChange={handleChange} />
        </Form.Group>
